 ...
 <p id = "frmReply-p"> 답글쓰기</p>
  ...
  <form name="frmReply" method="post"  action="${contextPath}/board/addReply.do"   enctype="multipart/form-data">
    ...
    <tr>
    	...
    	<td>
    	<input type="text" value ="${parentNO}" disabled/>
	...
	<tr>
		...
		<td><input type="text" size="67"  maxlength="500" name="article_title"></td>
	</tr>
	<tr>
		<th align="right" valign="top"><br>내용:&nbsp; </th>
		<td><textarea name="article_content" rows="10" cols="65" maxlength="4000"> </textarea> </td>
	</tr>
	<tr>
