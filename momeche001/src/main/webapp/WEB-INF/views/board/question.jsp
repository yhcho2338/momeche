...
<c:forEach  var="qna" items="${qnaList}"  varStatus="qnaNum">
    ...
    <c:if test ="${member.mb_id == 'admin' or member.mb_level >= 6 }">
    <div style="margin-top:20px;">
    <a  style="color:white; margin-left:805px;" href="javascript:fn_articleForm('${isLogOn}','${contextPath}/board/qna_articleForm.do','${contextPath}/member/loginForm.do')">
