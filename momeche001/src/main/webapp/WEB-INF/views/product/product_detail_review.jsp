...
<html lang="en">
	...
	<div class="product-main-introduce" style = "border:3px solid rgb(255, 187, 0)">
            ...
            <div class="goods-review-area" style = "border:3px solid red"> 
                <div class="goods-review-title" style = "border:3px solid rgb(145, 255, 0)"> 
                    <h1>사용후기</h1>
                    <hr width="63%">
                </div>

                <div class="goods-review-list-area">
                    <table class="goods-review-list" style = "border:3px solid green"" >
                       <thead>
                        <tr>
                            <th>번호</th>
                            <th>작성자</th>
                        ...
                        <tr>
                            ...
                            <td><div class="product-review-image"><img src="resources/image/product_001.jpg" alt="" style = "border:3px solid rgb(0, 68, 255)">
                            </div><div class="product-review-title-sample">후기에용</div></td>
                        ...
                        <tr>
                            ...
                            <td><div class="product-review-image"><img src="resources/image/product_001.jpg" alt="" style = "border:3px solid rgb(0, 68, 255)">
                            </div><div class="product-review-title-sample">향수 맘에 들어요</div></td>
                ...
                <div class= "product-review-add-button" style = "border:3px solid rgb(145, 255, 0)">
